...
@section('isi')
<div class="pagetitle d-flex flex-column flex-md-row justify-content-md-between align-items-start align-items-md-center mb-3">
        ...
        <table id="produks" class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr data-id="{{ $produk->id }}"
                    ...
                    <td><img src="{{ asset('storage/' . $produk->foto_produk) }}" alt="Foto Produk" class="img-fluid rounded" style="max-width: 80px;"></td>
                    <td>{{ $produk->deskripsi_produk }}</td>
                    <td class="text-center">Rp {{ number_format($produk->harga_kg,0,',','.') }}</td>
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                            <button class="btn btn-sm btn-warning btn-edit" data-bs-toggle="modal" data-bs-target="#modalEditProduk">
                                <i class='bx bx-edit'></i>
                            </button>

                            <form class="form-hapus" action="{{ route('produk.destroy', $produk->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
            ...
            <div class="modal-body">
                <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="foto_produk" class="form-control file-input" data-preview="previewTambah" accept="image/*" required>
                        <div class="mt-3">
        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-body">
                <form id="formEditProduk" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Foto Produk</label>
                        <input type="file" name="foto_produk" id="editFoto" class="form-control file-input" data-preview="previewEdit" accept="image/*">
                        <div class="mt-3">
